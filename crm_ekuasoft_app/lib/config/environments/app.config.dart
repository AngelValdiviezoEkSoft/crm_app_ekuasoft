class AppConfig {
  //GOOGLE MAP
  final String apiKeyAndroid = 'AIzaSyBNRevgaESKXBVcIFnEPVBQcTc1i_yqE6k';
  ...
  final String rutaGifCoheteBlanco = 'assets/gifs/gifCoheteBlanco.gif';
  final String rutaGifCoheteGris = 'assets/gifs/gifCoheteGris.gif';
  final String rutaGifCoheteMorado = 'assets/gifs/gifCoheteMorado.gif';
  ...
  final String rutaGifProcesandoBlanco = 'assets/gifs/gifProcesandoBlanco.gif';
  final String rutaGifProcesandoGris = 'assets/gifs/gifProcesandoGris.gif';
  final String rutaGifProcesandoMorado = 'assets/gifs/gifProcesandoMorado.gif';
  final String rutaGifTarjetaCheckBlanco = 'assets/gifs/gifTarjetaCheckBlanco.gif';
  final String rutaGifTarjetaCheckGris = 'assets/gifs/gifTarjetaCheckGris.gif';
  final String rutaGifTarjetaChekMorado = 'assets/gifs/gifTarjetaCheckMorado.gif';
  final String rutaGifXBlancos = 'assets/gifs/gifXBlanco.gif';
  final String rutaGifXGris = 'assets/gifs/gifXGris.gif';
  final String rutaGifXMorado = 'assets/gifs/gifXMorado.gif';
