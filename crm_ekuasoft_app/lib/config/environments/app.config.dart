class AppConfig {
  ...
  final String rutaGifProcesandoGris =
      'assets/gifs/gifProcesandoGris.gif';
  final String rutaGifProcesandoMorado =
      'assets/gifs/gifProcesandoMorado.gif';
  final String rutaGifTarjetaCheckBlanco =
      'assets/gifs/gifTarjetaCheckBlanco.gif';
  final String rutaGifTarjetaCheckGris =
      'assets/gifs/gifTarjetaCheckGris.gif';
  final String rutaGifTarjetaChekMorado =
      'assets/gifs/gifTarjetaCheckMorado.gif';
