...
class _ReasignaClienteScreenState extends State<ReasignaClienteScreen> {
  ...
  late Future<String> _futureVendedores;
  ...
  void initState() {
    ...
    _futureVendedores = gtVendedores();
  }
      ...
      body: BlocBuilder<GenericBloc, GenericState>(
        builder: (context,state) {
          ...
          return FutureBuilder(
            future: _futureVendedores,//ClienteService().getVendedores(),
...
Future<String> gtVendedores() async {
  try{
    List<ClientModelResponse> rsp = await ClienteService().getVendedores();
